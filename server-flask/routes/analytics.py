...
def get_revenue():
    ...
    total_rev = sum(b.get("grandTotal", 0) for b in bills)
...
def get_profit_trend():
    ...
    for bill in bills:
        ...
        daily_profit[date_str]["revenue"] += bill.get("grandTotal", 0)
...
def sales_trend():
    ...
    for bill in sales:
        ...
        daily_sales[date_str]["revenue"] += bill.get("grandTotal", 0)
...
def revenue_profit():
    ...
    for bill in bills:
        ...
        daily_map[date_iso]["revenue"] += bill.get("grandTotal", 0)
