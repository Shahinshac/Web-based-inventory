...
def _create_indexes(database):
    ...
    try:
        ...
        database.products.create_index("barcode", sparse=True)
        database.products.create_index("quantity")

        # EMI Plans indexes
        database.emi_plans.create_index("customerId")
        database.emi_plans.create_index("billId")
        database.emi_plans.create_index("billNumber")
        database.emi_plans.create_index("status")
        database.emi_plans.create_index("createdAt")

        # Expenses indexes
        database.expenses.create_index("date")
        database.expenses.create_index("category")
        database.expenses.create_index("expenseType")
        database.expenses.create_index("autoGenerated")

        # Returns indexes
        database.returns.create_index("invoiceId")
        database.returns.create_index("customerId")
        database.returns.create_index("createdAt")

        # Tickets indexes
        database.tickets.create_index("customerId")
        database.tickets.create_index("status")
        database.tickets.create_index("createdAt")

        # Payment Requests indexes
        database.payment_requests.create_index("customerId")
        database.payment_requests.create_index("status")
